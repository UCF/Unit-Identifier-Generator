...
ADMINS = (
    ('Jo Greybill', 'carolyn.greybill@ucf.edu'),
)
...
STATIC_ROOT = 'static/unit_identifier_widget/'
...
ADMIN_MEDIA_ROOT = '/home/www/static/admin/'
...
SECRET_KEY = 'u*!6e=@7oe*@-13gmahynd%74&amp;m+m*yg(h8f(*85h^f!nv+1f+'
...
ROOT_URLCONF = 'unit_identifier_widget.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'unit_identifier_widget.wsgi.application'
